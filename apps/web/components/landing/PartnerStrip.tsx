  ...
  return (
    <section className="border-b border-white/10 py-16">
      <div className="mx-auto max-w-6xl px-6">
        <p className="text-center font-mono text-[10px] font-semibold uppercase tracking-[0.16em] text-muted">
          Built with
        </p>
        <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {PARTNERS.map((partner) => (
            ...
            >
              <p className="font-display text-xl tracking-[-0.01em]">{partner.name}</p>
